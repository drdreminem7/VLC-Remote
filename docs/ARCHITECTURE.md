...
- `macos/MenuBarLauncher.swift` is an optional native macOS application. It
...
service log. The native app receives the URL through a private child-process pipe
and displays its QR in a Mac window.
